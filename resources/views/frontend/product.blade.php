            ...
            <div class="row mb-5">
                        ...
                        <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                            <div class="owl-thumbs d-flex flex-row flex-sm-column" data-slider-id="1">
                                <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100"
                                                                                             src="{{asset('frontend/img/product-detail-1.jpg')}}"
                                                                                             alt="..."></div>
                                <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100"
                                                                                             src="{{asset('frontend/img/product-detail-2.jpg')}}"
                                                                                             alt="..."></div>
                                <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100"
                                                                                             src="{{asset('frontend/img/product-detail-3.jpg')}}"
                                                                                             alt="..."></div>
                                <div class="owl-thumb-item flex-fill mb-2"><img class="w-100"
                                                                                src="{{asset('frontend/img/product-detail-4.jpg')}}"
                                                                                alt="..."></div>
                            </div>
                        </div>
                        <div class="col-sm-10 order-1 order-sm-2">
                            <div class="owl-carousel product-slider" data-slider-id="1"><a class="d-block"
                                                                                           href="{{asset('frontend/img/product-detail-1.jpg')}}"
                                                                                           data-lightbox="product"
                                                                                           title="Product item 1"><img
                                        class="img-fluid" src="{{asset('frontend/img/product-detail-1.jpg')}}"
                                        alt="..."></a><a
                                    class="d-block" href="{{asset('frontend/img/product-detail-2.jpg')}}"
                                    data-lightbox="product"
                                    title="Product item 2"><img class="img-fluid"
                                                                src="{{asset('frontend/img/product-detail-2.jpg')}}"
                                                                alt="..."></a><a class="d-block"
                                                                                 href="{{asset('frontend/img/product-detail-3.jpg')}}"
                                                                                 data-lightbox="product"
                                                                                 title="Product item 3"><img
                                        class="img-fluid" src="{{asset('frontend/img/product-detail-3.jpg')}}"
                                        alt="..."></a><a
                ...
                <div class="col-lg-6">
                    ...
                    <p class="text-small mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ut
                        ullamcorper leo, eget euismod orci. Cum sociis natoque penatibus et magnis dis parturient montes
                        nascetur ridiculus mus. Vestibulum ultricies aliquam convallis.</p>
                    ...
                    <ul class="list-unstyled small d-inline-block">
                        ...
                        <li class="px-3 py-2 mb-1 bg-white text-muted"><strong
                                class="text-uppercase text-dark">Tags:</strong><a class="reset-anchor ml-2" href="#">Innovation</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="tab-content mb-5" id="myTabContent">
                <div class="tab-pane fade show active" id="description" role="tabpanel"
                    ...
                    <div class="p-4 p-lg-5 bg-white">
                        ...
                        <p class="text-muted text-small mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="media mb-3"><img class="rounded-circle"
                                                             src="{{asset('frontend/img/customer-1.png')}}" alt=""
                                                             width="50">
                                ...
                                <div class="media"><img class="rounded-circle"
                                                        src="{{asset('frontend/img/customer-2.png')}}" alt=""
                                                        width="50">
                                    <div class="media-body ml-3">
                                        <h6 class="mb-0 text-uppercase">Jason Doe</h6>
                                        <p class="small text-muted mb-0 text-uppercase">20 May 2020</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product text-center skel-loader">
                        <div class="d-block mb-3 position-relative"><a class="d-block"
                                                                       href="{{route('frontend.product')}}"><img
