        ...
        <div class="container p-0">
            <div class="row">
                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    ...
                    <div class="py-2 px-4 bg-light mb-3"><strong class="small text-uppercase font-weight-bold">Electronics</strong>
                    </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                <div class="mb-3 position-relative">
                                    ...
                                    <a class="d-block" href="{{route('frontend.detail')}}"><img class="img-fluid w-100"
                                    ...
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            ...
                                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark"
                                                                                    href="{route('frontend.cart')}}">Add to
                                                    cart</a></li>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                <div class="mb-3 position-relative">
                                    ...
                                    <a class="d-block" href="{route('frontend.detail')}}"><img class="img-fluid w-100"
                                                                                    src="{{asset('frontend/img/product-9.jpg')}}"
                                                                                    alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark"
                                    ...
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark"
                                                        ...
                                                        class="far fa-heart"></i></a></li>
                                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark"
                                                                                    href="c{route('frontend.cart')}}">Add to
                                                    cart</a></li>
                                            <li class="list-inline-item mr-0"><a class="btn btn-sm btn-outline-dark"
                                                                                 href="#productView"
                                                                                 data-toggle="modal"><i
