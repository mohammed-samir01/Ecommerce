...
@section('content')
    ...
    <section class="pt-5">
        ...
        <div class="row">
            <div class="col-md-4 mb-4 mb-md-0"><a class="category-item" href="shop.blade.php"><img class="img-fluid"
                                                                                                   src="{{asset('frontend/img/cat-img-1.jpg')}}"
                                                                                                   alt=""><strong
                        class="category-item-title">Clothes</strong></a></div>
            <div class="col-md-4 mb-4 mb-md-0"><a class="category-item mb-4" href="shop.blade.php"><img
                        class="img-fluid" src="{{asset('frontend/img/cat-img-2.jpg')}}" alt=""><strong
