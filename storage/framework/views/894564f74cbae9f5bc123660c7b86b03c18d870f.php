<div class="card-body">
    <form action="<?php echo e(route('admin.product_categories.index')); ?>" method="get">
        <div class="row">
            <div class="col-2">
...
<?php /**PATH C:\xampp\htdocs\finalecommerce\Ecommerce-BackEnd\resources\views/backend/product_categories/filter/filter.blade.php ENDPATH**/ ?>