            ...
            <div class="col-2">
                <div class="form-group">
                    <select name="sort_by" class="form-control">
                        ...
                        <option value="first_name" <?php echo e(old('sort_by', request()->input('sort_by')) == 'first_name' ? 'selected' : ''); ?>>First Name</option>
                        <option value="last_name" <?php echo e(old('sort_by', request()->input('sort_by')) == 'last_name' ? 'selected' : ''); ?>>Last Name</option>
...
<?php /**PATH C:\xampp\htdocs\finalecommerce\Ecommerce-BackEnd\resources\views/backend/customers/filter/filter.blade.php ENDPATH**/ ?>