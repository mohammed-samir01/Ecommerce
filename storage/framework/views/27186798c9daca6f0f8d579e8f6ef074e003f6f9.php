<div class="card-body">
    <form action="<?php echo e(route('admin.tags.index')); ?>" method="get">
        <div class="row">
            <div class="col-2">
...
<?php /**PATH C:\xampp\htdocs\finalecommerce\Ecommerce-BackEnd\resources\views/backend/tags/filter/filter.blade.php ENDPATH**/ ?>